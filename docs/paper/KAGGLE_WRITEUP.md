...
![Figure 1 — the predicted collapse, measured on the private board](fig_collapse.png)
...
![Figure 2 — defense comparison](fig_defense.png)
...
![Figure 3 — the governing axis, made explicit](fig_frontier.png)
...
![Figure 4 — method progression](fig_method.png)
