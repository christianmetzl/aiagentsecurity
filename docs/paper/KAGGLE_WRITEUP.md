...
[12] C. Metzl. *FORGE: guardrail-adaptive replay search for multi-step tool attacks — code, offline harness, and one-command reproduction.* GitHub, 2026 (MIT). https://github.com/christianmetzl/aiagentsecurity
