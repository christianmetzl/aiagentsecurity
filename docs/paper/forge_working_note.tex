...
(\code{gpt-oss-20b} and \code{gemma-4-26B-A4B-it}, the latter a 26B mixture-of-experts with $\approx$4B
active parameters, both served as \code{Q4\_K\_M} GGUF) and is scored by the security predicates the
models are induced to trigger. Rather than treat the task as prompt engineering, we \textbf{reverse-engineer its reward
