...
| `docs/paper/` | **The working note** (`forge_working_note.pdf` / `.tex` / `.docx`, `KAGGLE_WRITEUP.md`) — the full write-up: scoring reverse-engineering, the guardrail failure taxonomy, FORGE, the matched defense, the measured final results, and figures. |
